...
from inventory.models import Product, Product_ProductType, ProductType
...
def test_model_structure_table_exists():
    try:
        from inventory.models import Product_ProductType  # noqa F401
    except ImportError:
        assert False
    else:
        assert True
...
@pytest.mark.parametrize(
    ...
    [
        (Product_ProductType, "id", models.AutoField),
    ],
)
